...
public class MemberAccountHandler {
    ...
    public MemberAccount updateAccountStatus(final MemberAccount account,MemberAccount.Status status) {
    ...
    private MemberAccount create(final Member m, final MemberAccountType at) {
        ...
        member.setAccountStatus(m.getAccountStatus());
        ...
        account.setStatus(MemberAccount.Status.valueOf(member.getAccountStatus().name()));
