 ...
 * @author luis
 */
public class GetMfsTransactionsDTO extends GetTransactionsDTO {
    ...
    public GetMfsTransactionsDTO() {
    }

    public GetMfsTransactionsDTO(final Account account) {
     ...
     */
    public GetMfsTransactionsDTO(final Account account, final Calendar date) {
        this(account, Period.endingAt(date));
    }

    public GetMfsTransactionsDTO(final Account account, final Period period) {
        super(account);
        this.period = period;
    }

    public GetMfsTransactionsDTO(final AccountOwner owner, final AccountType type) {
        this(owner, type, null, null);
    }

    public GetMfsTransactionsDTO(final AccountOwner owner, final AccountType type, final Calendar date) {
        this(owner, type, Period.endingAt(date), null);
    }

    public GetMfsTransactionsDTO(final AccountOwner owner, final AccountType type, final Period period) {
        this(owner, type, period, null);
    }

    public GetMfsTransactionsDTO(final AccountOwner owner, final AccountType type, final Period period, final PaymentFilter paymentFilter) {
        super(owner, type);
        this.period = period;
