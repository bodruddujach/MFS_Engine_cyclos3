...
public enum TransactionType {
  ...
  ADD_MONEY_FSIBL_FROM_FIRSTCASH("Add Money From FSIBL BY FirstCash"),
  ...
  SETTLEMENT_ADD_MONEY_FSIBL_FROM_FIRSTCASH("Settlement Add Money From FSIBL By FirstCash"),
